 ...
 * instead of {@linkplain OnClickListener OnClickListener}:
 * <pre><code>
 ...
 * </code></pre>
 * <p/>
 * Using static {@linkplain #wrap(OnClickListener) wrap} method can simply make an
 * exist {@linkplain OnClickListener OnClickListener} to be a {@linkplain
...
public abstract class ClickGuard {
    ...
    /**
     * Utility method. Let the provided {@linkplain OnClickListener OnClickListener}
    ...
    /**
     * Utility method. Retrieve {@linkplain OnClickListener OnClickListener} from
     * a View.
     *
     * @param view The View used to retrieve.
     * @return The retrieved {@linkplain OnClickListener OnClickListener}.
     */
    ...
    /**
     * Like {@link #add(View)}. Let a series of views to be guarded by this ClickGuard.
     *
     * @param view   The view to be guarded.
     * @param others More views to be guarded.
     * @return This ClickGuard instance.
    ...
    /**
     * Let the provided {@link OnClickListener} to be a {@link GuardedOnClickListener}
